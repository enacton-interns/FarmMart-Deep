        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center">
              <span className="text-green-400 text-2xl font-bold">FarmMarket</span>
            </div>
            <p className="mt-4 text-gray-400 max-w-md">
              Connecting local farmers with conscious consumers to create a more sustainable and transparent food system.
            </p>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">For Consumers</h3>
            <ul className="mt-4 space-y-4">
              ...
              <li>
                <Link href="/farmers" className="text-base text-gray-300 hover:text-white">
                  Meet Our Farmers
                </Link>
              </li>
              <li>
                <Link href="/recipes" className="text-base text-gray-300 hover:text-white">
                  Recipes & Tips
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-400 tracking-wider uppercase">For Farmers</h3>
            <ul className="mt-4 space-y-4">
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0 flex space-x-6">
              ...
              <Link href="/accessibility" className="text-base text-gray-400 hover:text-white">
                Accessibility
              </Link>
            </div>
          </div>
